      ...
      {tab === 'claim' && filteredClaims.map(claim => (
        <div key={claim.id} className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm">
          <div className="flex justify-between items-start mb-2">
            <div className="min-w-0 pr-2 flex flex-wrap items-center">
            ...
            <span className="shrink-0 whitespace-nowrap text-[10px] font-bold text-blue-600 bg-blue-50 px-2 py-1 rounded-full">{claim.status}</span>
          </div>
      ...
      {tab === 'inpatient' && filteredInpatients.map(app => (
        <div key={app.id} className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm">
          <div className="flex justify-between items-start mb-2">
            ...
            <span className="shrink-0 whitespace-nowrap text-[10px] font-bold text-purple-600 bg-purple-50 px-2 py-1 rounded-full">{app.status}</span>
          </div>
          <div className="text-xs text-slate-600 space-y-1 mb-3">
